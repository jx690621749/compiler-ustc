...
ARCH_LIB=${LIB_DIR}/edu.ustc.cs.compile.arch.jar

LAB_CLS_DIR=../classes

CLASSPATH=${PLATFORM_LIB}:${AST_LIB}:${JAVACUP_RUNTIME_LIB}:${PARSER_LIB}:${ARCH_LIB}:${LAB_CLS_DIR}

if [ $# -lt 1 ]; then
    java -classpath ${CLASSPATH} \
         edu.ustc.cs.compile.platform.Main \
         --cfg-file ../config/lab6-1.xml
else
    java -classpath ${CLASSPATH} \
         edu.ustc.cs.compile.platform.Main $*
fi