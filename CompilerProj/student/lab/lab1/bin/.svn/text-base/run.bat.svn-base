...
set PARSER_DIR=%ROOT_DIR%\lib
set PARSER_LIB=%PARSER_DIR%\edu.ustc.cs.compile.parser.simpleminijool.jar

set LAB1_CLS_DIR=..\classes

set CLASSPATH=%PLATFORM_LIB%;%AST_LIB%;%JAVACUP_RUNTIME_LIB%;%PARSER_LIB%;%LAB1_CLS_DIR%
...
:NA
java -classpath %CLASSPATH% edu.ustc.cs.compile.platform.Main --cfg-file ..\config\lab1-parser.xml
