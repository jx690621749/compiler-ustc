/* Generated By:JavaCC: Do not edit this line. ExprEParserTokenManager.java */
...
public class ExprEParserTokenManager implements ExprEParserConstants
{
...
"", null, null, null, null, null, null, "\50", "\51", "\73", "\53", "\55", 
"\52", "\57", "\75", };
...
public ExprEParserTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ExprEParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
